...
LOGO_PATH = os.path.join(
	frappe.get_app_path("its_erp_review"),
	"public",
	"its-logo.png"
)
...
TITLE_MAP = {
	...
	"Quality NCR": "Quality Non-Conformance Report (NCR)",
	"Technical Submittal": "Technical Submittal",
	"Subcontract Agreement": "Subcontract Agreement",
	"Equipment Usage Log": "Equipment Usage Log",
	"Project": "Project Master Document",
	"Customer": "Customer Profile & Statement",
	"Supplier": "Supplier Profile & Assessment",
	"Employee": "Employee Record Sheet"
}
...
def get_its_doc_items(doc):
	...
	for idx, r in enumerate(raw_rows, 1):
		...
		uom = getattr(r, "uom", None) or getattr(r, "stock_uom", None) or getattr(r, "unit", None) or "Nos"
